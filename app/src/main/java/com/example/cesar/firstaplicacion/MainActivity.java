...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //obtener una referencia de los controles
        txtNombre = (EditText) findViewById(R.id.txtname);
        btnVamos = (Button) findViewById(R.id.Vamonos);
        btnclic = (Button) findViewById(R.id.btnHola);
        txtone = (TextView) findViewById(R.id.HereYou);
        //implementar el evento clic
        btnclic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txtone.setVisibility(View.VISIBLE);
                txtone.setText(txtNombre.getText() + " estuvo aqui !!");
            }
        });
        btnVamos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bun.putString("Saludo",txtNombre.getText().toString());
